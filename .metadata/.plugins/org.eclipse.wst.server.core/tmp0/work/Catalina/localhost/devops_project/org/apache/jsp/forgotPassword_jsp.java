 ...
 * Generated at: 2022-12-04 08:55:45 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<li><span class=\"text-primary text-medium\">3. </span>Enter\r\n");
      out.write("\t\t\t\t\t\t\tthe OTP on the next page</li>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t\t<form action=\"/devops_project/login.jsp\" class=\"inline\">\r\n");
      out.write("\t\t\t\t\t\t<button >Back to login </button>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tid=\"email-for-pass\" required=\"\"><small\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"form-text text-muted\">Enter the registered email\r\n");
      out.write("\t\t\t\t\t\t\t\taddress . Then we'll email a OTP to this address.</small>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
